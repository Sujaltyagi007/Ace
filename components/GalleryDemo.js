...
export default function GalleryDemo({item}) {
    return (
        <section className="w-full py-10 mx-auto container">
            ...
            <div className="grid grid-rows-2 grid-cols-none sm:grid-rows-none sm:grid-cols-12 gap-4 py-4 h-fit sm:h-[70vh] ">
                <div className="relative border col-span-1 sm:col-span-5 group cursor-pointer h-full  ">
                    <Link href={`${item.link}`}>
                ...
                <div className=" relative col-span-1 sm:col-span-7 gap-4 grid grid-rows-2 w-full sm:grid-rows-1 grid-cols-1 sm:grid-cols-24 h-full ">
                    <div className=" flex flex-col gap-4 col-span-1 border sm:col-span-13 h-full ">
                        <div className=" relative flex flex-col sm:flex-row gap-4 h-full sm:h-1/2 ">
                            <div className=" relative w-fit sm:w-1/2 group cursor-pointer ">
                                <Link href={`${item.link}`}>
                                    <div className="absolute z-10 w-full h-full opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto scale-[100%] group-hover:scale-[102%] transition-all duration-300 ease-in border group-hover:border-6 border-orange-500 rounded-3xl p-4">
                                        <div className=" bg-orange-500/50 w-full h-full flex justify-center items-center rounded-3xl ">
                                            <Image src={Eyes} width={100} height={100} alt="About-Eyes" className="" />
                                    ...
                                    <Image src={item.images.img2} fill alt="Gallery-Image-AboutSection" className="rounded-3xl " />
                                </Link>
                            </div>
                            <div className=" relative w-1/2 group cursor-pointer " >
                                <Link href={`${item.link}`}>
                                    ...
                                    <Image src={item.images.img3} fill alt="Gallery-Image-AboutSection" className="rounded-3xl " />
                                </Link>
                            </div>
                        </div>
                        <div className=" relative flex h-1/2 group cursor-pointer ">
                            <Link href={`${item.link}`}>
                                ...
                                <Image src={item.images.img4} fill alt="Gallery-Image-AboutSection" className=" rounded-3xl " />
                            </Link>
                        </div>
                    </div>
                    <div className=" gap-4 grid grid-rows-12 col-span-11  ">
                        <div className=" relative grid row-span-7 group cursor-pointer ">
                            <Link href={`${item.link}`}>
                                ...
                                <Image src={item.images.img5} fill alt="Gallery-Image-AboutSection" className=" border-amber-500 rounded-3xl" />
                            </Link>
                        </div>
                        <div className=" relative grid row-span-5 group cursor-pointer">
                            <Link href={`${item.link}`}>
                                ...
                                <Image src={item.images.img6} fill alt="Gallery-Image-AboutSection" className=" rounded-3xl" />
                            </Link>
                        </div>
                    </div>
                </div>
