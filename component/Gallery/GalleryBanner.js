        ...
        <section className=' relative mt-[12%] md:mt-[4.3%] lg:mt-[4%] xl:mt-[4%] w-full h-full  '>
            ...
            >
                ...
                <div className=' absolute inset-0 z-20  flex flex-col gap-4 justify-center items-center h-full text-white '>
                    <p className={`${comic.className} font-extrabold text-3xl lg:text-7xl `}>Gallery</p>
                    <span className=' flex justify-center items-center gap-1 text-[#ffbb01]'><Link href='/'><p>Home</p></Link><MdOutlineDoubleArrow /><Link href='/Gallery'><p>Gallery</p></Link></span>
                </div>
            </div>
        </section>
    )
